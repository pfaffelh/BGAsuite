#' Data for 115 AIMs from the VISAGE BASIC TOOL; this dataset can serve as a reference database
#'
#' @docType data
#'
#' @usage data(VISAGE.BASIC.TOOL.snipper.reference)
#'
...
#'
#' @source \href{http://mathgene.usc.es/snipper/VISAGE%20Basic%20Tool%20ancestry%20panel%20Training%20Set.xlsx}{Snipper homepage, first sheet}
#'
#' @examples
#' data(VISAGE.BASIC.TOOL.snipper.reference)
"VISAGE.BASIC.TOOL.snipper.reference"
